    ...
    <div class="row">
        <div class="col s12 m6">
            <div class="card purple darken-2">
                ...
                <div class="card-action"><a href="{{ route('usuarios.index') }}">Visualizar</a></div>
            </div>
        </div>
        ...
        <div class="col s12 m6">
            <div class="card blue">
                ...
                <div class="card-action"><a href="#">Visualizar</a></div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col s12 m6">
            <div class="card orange darken-4">
                <div class="card-content white-text">
                    <span class="card-title">Papeis</span>
                    <p>Listar papeis do sistema</p>
                </div>
                <div class="card-action"><a href="#">Visualizar</a></div>
            </div>
        </div>
